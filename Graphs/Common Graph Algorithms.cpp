...
class Graph {
   public:
    ...
    void findLevelOfEachNode(int v) {
        ...
        // v will be level 0		//this can be usde to find the shortest path between two nodes (shortest path =
    ...
    int findMotherVertex() {
        // If mother vertex exists it will be the last visited vertex by DFSutil (bcoz after it everything would have
        // have been visited) After that we have to check if the last visited vertex actually visits all the vertices
